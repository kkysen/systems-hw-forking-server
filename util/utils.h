...
#define check(ret_val) if ((ret_val) == -1) return -1
#define check_perror(ret_val) if ((ret_val) == -1) return perror(#ret_val), -1
#define check_msg(ret_val, msg) if ((ret_val) == -1) return perror(msg), -1
